...
{
public:
	ID3D12CommandList* m_batchSubmit[MaxContexts/*NumContexts*/ * 2 + CommandListCount];
	...
	ComPtr<ID3D12CommandAllocator> m_shadowCommandAllocators[MaxContexts/*NumContexts*/];
	ComPtr<ID3D12GraphicsCommandList> m_shadowCommandLists[MaxContexts/*NumContexts*/];

	ComPtr<ID3D12CommandAllocator> m_sceneCommandAllocators[MaxContexts/*NumContexts*/];
	ComPtr<ID3D12GraphicsCommandList> m_sceneCommandLists[MaxContexts/*NumContexts*/];
