...
private:
	...
	HANDLE m_workerBeginRenderFrame[MaxContexts];
	HANDLE m_workerFinishShadowPass[MaxContexts];
	HANDLE m_workerFinishedRenderFrame[MaxContexts];
	HANDLE m_threadHandles[MaxContexts];
	UINT m_frameIndex;
	HANDLE m_fenceEvent;
	...
	ThreadParameter m_threadParameters[MaxContexts];
